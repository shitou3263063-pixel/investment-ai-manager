...
from src.data.market_agent import MarketAgent
...
from src.portfolio.agent import PortfolioAgent
...
from src.strategy.decision_agent import DecisionAgent
from src.strategy.dca_engine import build_dca_plan
from src.strategy.execution_plan import build_execution_plan
from src.strategy.rebalance_advisor import RebalanceAdvisor
...
def _build_context() -> tuple[
    ...
    live_market_result = fetch_market_data()
...
def run() -> str:
    ...
    reports_dir = reports_root / "latest"
    ...
    today_action = _write_today_action(decision_result, dca_result, allocation_rebalance_result, execution_plan_result)
    (reports_dir / "today_action.md").write_text(today_action, encoding="utf-8")
    ...
    (reports_dir / "chatgpt_brief.md").write_text(today_action, encoding="utf-8")
